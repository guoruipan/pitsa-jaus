  ...
  return (
    <>
      <h1 className="text-center font-bold text-2xl">
        Política de privacidad de PitsaJaus &#174;
      </h1>
      ...
      <p>
        ...
        proporciona a través de nuestro sitio web, aplicación móvil o cualquier
        otro medio.
      </p>
      ...
      <ul className="list-disc">
        ...
        <li>
          Se suscribe a nuestro boletín informativo: Recopilamos su
          dirección de correo electrónico.
        </li>
        <li>
          Nos contacta: Recopilamos su nombre, dirección de correo
          electrónico y cualquier otra información que nos proporcione.
        </li>
      </ul>
      ...
      <ul className="list-disc">
        <li>
          Proveedores de servicios que nos ayudan a operar nuestro negocio, como
          proveedores de procesamiento de pagos y empresas de entrega.
        </li>
        <li>
          Terceros que nos ayudan a mejorar nuestros productos y servicios, como
      ...
      <p>
        ...
        cualquier momento. Si realizamos cambios sustanciales a esta Política de
        Privacidad, se lo notificaremos por correo electrónico o mediante un
